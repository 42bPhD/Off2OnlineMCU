...
parser.add_argument('load', metavar='LOAD', default='./trained_models/RepVGG-C0/default/best_ckpt.pth', help='path to the weights file')
parser.add_argument('save', metavar='SAVE', default="./trained_models/RepVGG-C0/default/best_ckpt_deploy.pth", help='path to the weights file')
parser.add_argument('-a', '--arch', metavar='ARCH', default='RepVGG-C0')
